 ...
 */
class srcDevItop_portalProductionDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'combodo\\itop\\portal\\eventlistener\\itopuserprovider' => 'Combodo\\iTop\\Portal\\EventListener\\ItopUserProvider',
        ...
        $this->methodMap = array(
            'Combodo\\iTop\\Portal\\EventListener\\ItopUserProvider' => 'getItopUserProviderService',
        ...
        $this->fileMap = array(
            ...
            'bricks_collection' => 'getBricksCollectionService.php',
            ...
            'service_locator.4qejj2v' => 'getServiceLocator_4qejj2vService.php',
            'service_locator.nartgnl' => 'getServiceLocator_NartgnlService.php',
        ...
        $this->privates['service_container'] = function () {
            include_once $this->targetDirs[3].'/src/EventListener/ItopUserProvider.php';
            include_once $this->targetDirs[3].'/src/Security/ItopUser.php';
        };
    }
    ...
    {
        $this->services['router'] = $instance = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'kernel:loadRoutes', array('cache_dir' => $this->targetDirs[0], 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Combodo\\iTop\\Portal\\Routing\\UrlGeneratorItop', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'srcDevItop_portalProductionDebugProjectContainerUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'srcDevItop_portalProductionDebugProjectContainerUrlMatcher', 'strict_requirements' => NULL, 'resource_type' => 'service'), ${($_ = isset($this->services['router.request_context']) ? $this->services['router.request_context'] : $this->getRouter_RequestContextService()) && false ?: '_'});
    ...
    /**
     * Gets the private 'Combodo\iTop\Portal\EventListener\ItopUserProvider' shared autowired service.
     *
     * @return \Combodo\iTop\Portal\EventListener\ItopUserProvider
     */
    protected function getItopUserProviderService()
    {
        return $this->services['Combodo\iTop\Portal\EventListener\ItopUserProvider'] = new \Combodo\iTop\Portal\EventListener\ItopUserProvider(${($_ = isset($this->services['ModuleDesign']) ? $this->services['ModuleDesign'] : ($this->services['ModuleDesign'] = new \ModuleDesign('itop-portal'))) && false ?: '_'}, new \Combodo\iTop\Portal\Security\ItopUser(), 'http://localhost/itop/symfony-portal-poc/env-production/itop-portal-base/portal/web/');
    }

    /**
     * Gets the private 'ModuleDesign' shared autowired service.
     *
     * @return \ModuleDesign
     */
    protected function getModuleDesignService()
    {
        return $this->services['ModuleDesign'] = new \ModuleDesign('itop-portal');
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['Combodo\iTop\Portal\EventListener\ItopUserProvider']) ? $this->services['Combodo\iTop\Portal\EventListener\ItopUserProvider'] : $this->getItopUserProviderService()) && false ?: '_'};
        }, 1 => 'onKernelRequest'), 0);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'itop.cache_path': $value = $this->getEnv('ITOP_CACHE_PATH'); break;
            case 'kernel.secret': $value = $this->getEnv('APP_SECRET'); break;
            case 'session.save_path': $value = ($this->targetDirs[0].'/sessions'); break;
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcDevItop_portalProductionDebugProjectContainer.xml'); break;
    ...
    {
        return array(
            'kernel.environment' => 'devItop_portalProduction',
            'kernel.debug' => true,
            'kernel.name' => 'src',
            ...
            'kernel.bundles_metadata' => array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => '/var/www/itop/symfony-portal-poc/lib/composer-vendor/symfony/framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'TwigBundle' => array(
                    'parent' => NULL,
                    'path' => '/var/www/itop/symfony-portal-poc/lib/composer-vendor/symfony/twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ),
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'srcDevItop_portalProductionDebugProjectContainer',
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => true,
            'combodo.current_environment' => 'production',
            'combodo.absolute_url' => 'http://localhost/itop/symfony-portal-poc/',
            'combodo.modules.absolute_url' => 'http://localhost/itop/symfony-portal-poc/env-production',
            'combodo.portal.base.absolute_url' => 'http://localhost/itop/symfony-portal-poc/env-production/itop-portal-base/portal/web/',
            'combodo.portal.base.absolute_path' => '/var/www/itop/symfony-portal-poc/env-production//itop-portal-base/portal/web/',
            'combodo.portal.instance.absolute_url' => 'http://localhost/itop/symfony-portal-poc/env-production/itop-portal/',
            'combodo.portal.instance.id' => 'itop-portal',
            'combodo.portal.instance.conf' => array(
                'properties' => array(
                    'id' => 'itop-portal',
                    'name' => 'portal:itop-portal',
                    'logo' => 'http://localhost/itop/symfony-portal-poc/env-production/../images/logo-itop-dark-bg.svg',
                    'themes' => array(
                        'bootstrap' => 'http://localhost/itop/symfony-portal-poc/env-production/itop-portal-base/portal/web/css/bootstrap-theme-combodo.css',
                        'portal' => 'http://localhost/itop/symfony-portal-poc/env-production/itop-portal-base/portal/web/css/portal.css',
                        'others' => array(
                ...
                'portals' => array(
                    0 => array(
                        ...
                        'url' => 'http://localhost/itop/symfony-portal-poc/pages/exec.php?exec_module=itop-portal-base&exec_page=index.php&portal_id=itop-portal',
                    ),
                    1 => array(
                        'id' => 'backoffice',
                        'label' => 'iTop Back-Office User Interface',
                        'url' => 'http://localhost/itop/symfony-portal-poc/pages/UI.php',
                    ),
                ),
                'forms' => array(
            ...
            'combodo.portal.instance.routes' => array(

            ),
            'combodo.current_user.session_messages' => array(

            ),
            'router.options.generator_base_class' => 'Combodo\\iTop\\Portal\\Routing\\UrlGeneratorItop',
            'itop.portal_id' => 'itop-portal',
            ...
            'router.options.matcher.cache_class' => 'srcDevItop_portalProductionDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'srcDevItop_portalProductionDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => 'kernel:loadRoutes',
            'router.cache_class_prefix' => 'srcDevItop_portalProductionDebugProjectContainer',
